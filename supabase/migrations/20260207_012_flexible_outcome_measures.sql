...
CREATE INDEX IF NOT EXISTS idx_outcome_def_code ON outcome_measure_definitions(code);
CREATE INDEX IF NOT EXISTS idx_outcome_def_specialty ON outcome_measure_definitions USING GIN (specialty);
CREATE INDEX IF NOT EXISTS idx_outcome_def_category ON outcome_measure_definitions(category);
CREATE INDEX IF NOT EXISTS idx_outcome_def_active ON outcome_measure_definitions(is_active) WHERE is_active = TRUE;
...
DROP POLICY IF EXISTS "outcome_definitions_read" ON outcome_measure_definitions;
...
DROP POLICY IF EXISTS "outcome_definitions_write" ON outcome_measure_definitions;
...
DROP TRIGGER IF EXISTS update_outcome_definitions_updated_at ON outcome_measure_definitions;
