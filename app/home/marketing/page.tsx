...
export default function MarketingPage() {
  return (
    <PageShell activePage="marketing" className="mx-auto max-w-[1600px] pb-10">
          ...
          <div className="flex flex-1 items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <Text className="max-w-xl text-white/80">
                Automatically request reviews from satisfied patients, respond to feedback, monitor
                your online presence across platforms, and improve your search visibility with
      ...
      <CardWrapper className="mb-8 p-6">
        <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <Text muted>See how your practice visibility compares to nearby competitors</Text>
          </div>
        ...
        <div className="bg-warning-bg mb-6 flex items-start gap-3 rounded-lg p-4">
          ...
          <div>
            ...
            <Text size="sm" className="text-warning">
              Top-ranking practices are capturing 3-5x more patient inquiries through AI-powered
              search. You&apos;re missing opportunities to 60% of patients searching for care in
              your specialty.
            </Text>
          </div>
        </div>
                ...
                <tr key={competitor.rank}>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <span className="text-muted-foreground text-sm">#{competitor.rank}</span>
                      <div>
