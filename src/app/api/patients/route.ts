...
// Pronouns options (stored in metadata or a new field)
const VALID_PRONOUNS = ["He/Him", "She/Her", "They/Them", "Other"] as const;
type Pronouns = (typeof VALID_PRONOUNS)[number];
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Check for duplicate patient (same name + DOB)
