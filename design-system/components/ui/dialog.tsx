...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "flex flex-col-reverse gap-3 sm:flex-row sm:justify-end sm:gap-2 [&>button]:min-h-[48px] [&>button]:w-full sm:[&>button]:min-h-0 sm:[&>button]:w-auto",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-lg leading-none font-light tracking-tight text-black", className)}
    {...props}
  />
));
